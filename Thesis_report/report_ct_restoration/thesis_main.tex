...
% This is for students' theses
  \begin{deckblatt}
    \Titel{A Cascaded Encoder-Decoder Network for CT Image Restoration} % Title
...
CT-Bilder in der klinischen Praxis sind oft zugleich durch Poisson-Rauschen sowie Bewegungs-, Ring- und Metallartefakte gestört, während die meisten Verfahren diese Effekte getrennt behandeln. Diese Arbeit untersucht, ob kaskadierte Encoder--Decoder die CT-Bildrestauration unter solcher kombinierten Korruption verbessern. Dazu wird für LoDoPaB-CT ein physikalisch motiviertes Protokoll im Sinogrammraum entwickelt, und drei zweistufige Varianten werden verglichen: unabhängiges stufenweises Training, End-to-End-Training und eine Residualvariante.

Ein großes einstufiges U-Net erreicht unter der vorgeschlagenen Korruption 36.11 dB PSNR. Bei gleicher kleiner Kapazität pro Stufe bringt eine zweite Stufe nur begrenzte Verbesserungen gegenüber der kleinen einstufigen Basisvariante (35.39 dB), nämlich +0.15 bis +0.72 dB. Die beste kleine Kaskade nutzt Residualvorhersage zusammen mit Hann- und Shepp--Logan-gefilterten FBP-Eingaben und erreicht ebenfalls 36.11 dB, ohne die große einstufige Referenz zu übertreffen. Die Gradientenanalyse zeigt eine Abschwächung des Lernsignals der zweiten Stufe während der Konvergenz von Stufe 1. Dies deutet darauf hin, dass die für die zweite Stufe verfügbare Information und nicht allein die Netztiefe den Hauptengpass bildet.}
